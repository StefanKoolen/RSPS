				...
				public int leechDefenceDelay;
					public int leechMagicDelay;
						public int leechAttackDelay;
							...
							public int attackMultiplier, rangedMultiplier, defenceMultiplier, magicMultiplier, strengthMultiplier;
...
public int vSpearLeft = 1000;
    ...
    public String yellTag = null;
    public String yellBanReason = "Not banned from yell";
    public boolean canYell = true;
    public boolean customYell;
    public String[] defaultYellTag = { "<shad=8781568>[Player]", "<img=1><shad=25599>[Mod]<img=1>", "<img=2><shad=65535>[Admin]<img=2>", 
    "<img=2><shad=16736000>[Sexy Owner]<img=2>", "<img=3><shad=22272>[@Donator]<img=3>"};
	...
	isGfxDev,
	isHOS,
	antiDupe,		//For Lamps xp, and other items
	LampSelect,
	serverPoints,
	donatorPoints,
	tabletSelect,
	...
	followId2,
	barrageCount = 0,
	SETHOMEX = Config.RESPAWN_X,
    SETHOMEY = Config.RESPAWN_Y, 
	delayedDamage = 0,
	delayedDamage2 = 0,
	pfPoints = 0,
	donorPoints = 0,
...
// Ancient Spells
	...
	{15000,80,437,188,142,143,99,560,0,0,0,0,0,0,0,0},		//id is 52	arma storm
	{15001,80,4013,188,142,143,43,0,0,0,0,0,0,0,0,0},		//id is 53	polypore
	{15002,80,10503,0,1333,1333,47,500,4694,1,0,0,0,0,0,0},
	// example {magicId, level req, animation, startGFX, projectile Id, endGFX, maxhit, exp gained, rune 1, rune 1 amount, rune 2, rune 2 amount, rune 3, rune 3 amount, rune 4, rune 4 amount}
	...
	public boolean withinInteractionDistance(int x, int y, int z) {
		...
		if(playerEquipment[playerShield] == 13740) { // Divine Spirit Shield Effect
			...
			if(prayerPoint >0) {
			    if(playerLevel[3] > 4) {
					if(Misc.random(8) <= 6) {
						double damageRecieved = damage * 0.70;
							c.sendMessage("Your shield absorbs 30% of the hit...");
			...
			c.sendMessage("The Phoenix Necklace of life saves you but was destroyed in the process");
...
public boolean inMulti() {
    ...
    {
        return absX >= 2598 && absX <= 2609 && absY >= 9901 && absY <= 9917;
    }
