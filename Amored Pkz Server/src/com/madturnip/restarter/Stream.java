...
public class Stream {
	...
	public int readSignedWordBigEndian() {//2
		currentOffset += 2;
	...
	public int readUnsignedWordBigEndian() {//2
		currentOffset += 2;
		return ((buffer[currentOffset - 1] & 0xff) << 8)
				+ (buffer[currentOffset - 2] & 0xff);
	}

	public int readUnsignedWordA() {//1
		currentOffset += 2;
	...
	public void writeString(java.lang.String s) {
		...
		for (int i = 0; i < s.length(); i++) {
			buffer[currentOffset++] = (byte) s.charAt(i);
		}
	...
	public int readUnsignedByte() {
		int ubyte = buffer[currentOffset++] & 0xff;
		return ubyte;
	}
	...
	public int readUnsignedWord() {
		currentOffset += 2;
		int uword = ((buffer[currentOffset - 2] & 0xff) << 8)
	...
	public int readDWord() {
		currentOffset += 4;
		int dword = ((buffer[currentOffset - 4] & 0xff) << 24)
